# Multi-knowledge variant: same interface as subproblem_solver.pyx with my_subproblem_solver_cy_MK.
import numpy as np
cimport numpy as np
cimport cython
...
def my_subproblem_solver_cy_MK(np.ndarray[BTYPE_t, ndim=1] y_cur,
                           dict problem_dict):
    cdef:
